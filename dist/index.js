...
var MyAssets = /** @class */ (function () {
    ...
    MyAssets.isObjectLike = function (data) {
        return lodash.isObjectLike(data);
    };
    /**
     * 是否为中国大陆手机号
     * @param phone
...
var MyObject = /** @class */ (function () {
    ...
    MyObject.at = function (obj, path) {
        return lodash.at(obj, path).shift();
    };
    /**
...
var MySecret = /** @class */ (function () {
    ...
    MySecret.generatePassword = function (pd) {
        if (pd == '') {
            ...
            var first = tsMd5.Md5.hashStr(pd + pd.substr(0, 4));
            return tsMd5.Md5.hashStr(pd + first);
        }
    };
...
var MyHtml = /** @class */ (function () {
    ...
    MyHtml.reloadFiles = function () {
        ...
        each__default["default"](nodes, function (node) {
            // @ts-ignore
...
exports.AnyData = AnyData;
exports.MyArray = MyArray;
exports.MyAssets = MyAssets;
exports.MyBrowser = MyBrowser;
exports.MyCache = MyCache;
exports.MyDatetime = MyDatetime;
exports.MyHtml = MyHtml;
exports.MyMapConf = MyMapConf;
exports.MyMoney = MyMoney;
exports.MyObject = MyObject;
exports.MySecret = MySecret;
exports.MyString = MyString;
exports.MyTable = MyTable;
exports.MyTextService = MyTextService;
exports.MyTrie = MyTrie;
exports.MyTypecast = MyTypecast;
exports.MyUrl = MyUrl;
exports.ResListResult = ResListResult;
exports.StatusActive = StatusActive;
exports.StatusDisabled = StatusDisabled;
exports.getKvColor = getKvColor;
exports.getKvId = getKvId;
exports.getKvTitle = getKvTitle;
exports.getKvTitleById = getKvTitleById;
